    ...
    public void initView() {
        ...
        View.OnClickListener finishClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ToastUtils.showShortToast(mContext,"进入主页");
        ...
        View view1 = View.inflate(this, R.layout.intro_page_base, null);
        ((ImageView) view1.findViewById(R.id.title)).setImageResource(R.drawable.intro_top_text1);
        view1.findViewById(R.id.description).setVisibility(View.VISIBLE);
        viewArray.add(view1);

        View view2 = View.inflate(this, R.layout.intro_page_base, null);
        ((ImageView) view2.findViewById(R.id.title)).setImageResource(R.drawable.intro_top_text2);
        view2.findViewById(R.id.description).setVisibility(View.GONE);
        viewArray.add(view2);

        View view3 = View.inflate(this, R.layout.intro_page_base, null);
        ((ImageView) view3.findViewById(R.id.title)).setImageResource(R.drawable.intro_top_text3);
        view3.findViewById(R.id.description).setVisibility(View.GONE);
        viewArray.add(view3);

        View view4 = View.inflate(this, R.layout.intro_page_base, null);
        ((ImageView) view4.findViewById(R.id.title)).setImageResource(R.drawable.intro_top_text4);
        view4.findViewById(R.id.description).setVisibility(View.GONE);
        viewArray.add(view4);

        pageScene1_2 = Scene.getSceneForLayout((ViewGroup)findViewById(R.id.root_view_1_to_2), R.layout.intro_scene2, this);
        pageScene2_3 = Scene.getSceneForLayout((ViewGroup)findViewById(R.id.root_view_2_to_3), R.layout.intro_scene3, this);
        pageScene3_4 = Scene.getSceneForLayout((ViewGroup)findViewById(R.id.root_view_3_to_4), R.layout.intro_scene4, this);
        ...
        textScene1 = android.transitions.everywhere.Scene.getSceneForLayout(mTextSceneRoot, R.layout.intro_scene1_text, this);
        textScene2 = android.transitions.everywhere.Scene.getSceneForLayout(mTextSceneRoot, R.layout.intro_scene2_text, this);
        textScene3 = android.transitions.everywhere.Scene.getSceneForLayout(mTextSceneRoot, R.layout.intro_scene3_text, this);
        textScene4 = android.transitions.everywhere.Scene.getSceneForLayout(mTextSceneRoot, R.layout.intro_scene4_text, this);
